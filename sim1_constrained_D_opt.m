...
fprintf('Running constrained D-opt with %d Monte Carlo trials.\n', mc_trials);
...
title('constrained D-opt', 'FontSize', 8, 'FontWeight', 'normal', 'Interpreter', 'none');
...
title('constrained D-opt runtime', 'FontSize', 8, 'FontWeight', 'normal', 'Interpreter', 'none');
...
results = struct();
results.case_name = 'constrained D-opt';
...
writetable(trial_table, fullfile(output_dir, 'sim1_constrained_D_opt_trials.csv'));
writetable(summary_table, fullfile(output_dir, 'sim1_constrained_D_opt_summary.csv'));
savefig(fig_history, fullfile(output_dir, 'sim1_constrained_D_opt_history.fig'));
savefig(fig_runtime, fullfile(output_dir, 'sim1_constrained_D_opt_runtime.fig'));
func_save_figure(fig_history, fullfile(output_dir, 'sim1_constrained_D_opt_history.png'), 600);
func_save_figure(fig_runtime, fullfile(output_dir, 'sim1_constrained_D_opt_runtime.png'), 600);
results.history_fig = fullfile(output_dir, 'sim1_constrained_D_opt_history.fig');
results.runtime_fig = fullfile(output_dir, 'sim1_constrained_D_opt_runtime.fig');
results.history_png = fullfile(output_dir, 'sim1_constrained_D_opt_history.png');
results.runtime_png = fullfile(output_dir, 'sim1_constrained_D_opt_runtime.png');
save(fullfile(output_dir, 'sim1_constrained_D_opt_results.mat'), 'results', 'trial_table', 'summary_table', 'trial_results');
